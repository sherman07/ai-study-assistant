/**
 * App boot — mounts the React workspace shell and schedules the legacy controller.
 * Entry: frontend/src/main.js re-exports this module.
 */
import { App } from "../pages/workspace/index.js?v=notes-taller-v2";
...
export function bootSynapseRuntime() {
