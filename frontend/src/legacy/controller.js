import { API_BASE } from "./apiConfig.js?v=study-tools-guards-v1";
...
} from "./dataApiClient.js?v=study-tools-guards-v1";
import {
  safeGetLocalStorage,
  safeReadJSONStorage,
...
import {
  ...
  shorten,
  typeInto
} from "./markdownRenderer.js?v=study-tools-guards-v1";
import { LegacyControllerLoader } from "./controllerLoader.js?v=study-tools-guards-v1";

const CONTROLLER_VERSION = "study-tools-guards-v1";
