...
import { NotesToolbar } from "./NotesToolbar.js?v=notes-fullscreen-v1";
import { SourceViewerPanel } from "./SourceViewerPanel.js?v=notes-fullscreen-v1";
import { StudyTools } from "./StudyTools.js?v=notes-fullscreen-v1";
