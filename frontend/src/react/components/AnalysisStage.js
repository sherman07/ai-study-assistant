...
import { NotesToolbar } from "./NotesToolbar.js?v=mindmap-original-v1";
import { SourceViewerPanel } from "./SourceViewerPanel.js?v=mindmap-original-v1";
import { StudyTools } from "./StudyTools.js?v=mindmap-original-v1";
