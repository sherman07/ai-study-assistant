...
import { NotesToolbar } from "./NotesToolbar.js?v=notes-source-tall-v1";
import { SourceViewerPanel } from "./SourceViewerPanel.js?v=notes-source-tall-v1";
import { StudyTools } from "./StudyTools.js?v=notes-source-tall-v1";
