...
import { NotesToolbar } from "./NotesToolbar.js?v=notes-height-only-v1";
import { SourceViewerPanel } from "./SourceViewerPanel.js?v=notes-height-only-v1";
import { StudyTools } from "./StudyTools.js?v=notes-height-only-v1";
