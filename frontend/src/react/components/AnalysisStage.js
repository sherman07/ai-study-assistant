...
import { NotesToolbar } from "./NotesToolbar.js?v=notes-responsive-v1";
import { SourceViewerPanel } from "./SourceViewerPanel.js?v=notes-responsive-v1";
import { StudyTools } from "./StudyTools.js?v=notes-responsive-v1";
