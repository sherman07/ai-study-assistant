...
assert.ok(mainEntry.includes("./app/main.js"), "workspace entry should boot through app/main.js");
...
const reset = readLegacyControllerSections("08_extractrealtimeresponsetranscript.js");
const history = readLegacyControllerSections("09_togglesourceviewer.js");
const broadcastController = readLegacyControllerSections("12_broadcastjobs.js");
const backendApp = readBackendAppSource();
const backendBroadcastMode = readBackendAppSections("13_broadcast_mode.py");
