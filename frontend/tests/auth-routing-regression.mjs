...
assert.ok(
  /config\.js\?v=(?:legacy-boot-fix-v1|login-remember-v1|credits-model-v1|credits-live-v2|notes-fullscreen-v1)/.test(workspacePage),
  "Workspace must bypass cached runtime config"
);
assert.ok(
  /auth-client\.js\?v=(?:signup-email-v1|credits-model-v1|credits-live-v2|notes-fullscreen-v1)/.test(workspacePage),
...
assert.ok(
  /style\.css\?v=(?:mindmap-theta-v1|legacy-boot-fix-v1|mindmap-revert-v1|notes-responsive-v2|credits-live-v2|notes-fullscreen-v1)/.test(workspacePage),
