...
const uploadSection = readLegacyControllerSections("01_uploadedfiles.js");
const historySection = readLegacyControllerSections("09_togglesourceviewer.js");
const focusBridge = readLegacyControllerSections("10_focusroombridge.js");
...
const focusRoomData = focusRoomDataSource();
...
const focusRoomStore = focusRoomStoreSource();
