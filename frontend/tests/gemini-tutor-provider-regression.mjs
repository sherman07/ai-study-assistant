...
assert.ok(/mindmap-revert-v1|notes-true-fullscreen-v1|notes-responsive-v2|credits-live-v2/.test(index), "workspace assets should cache-bust after Gemini/web research fix");
