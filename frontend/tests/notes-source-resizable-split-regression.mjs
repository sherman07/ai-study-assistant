...
assert.ok(index.includes("style.css?v=source-preview-instant-v1"), "styles should cache-bust for the resizable split");
assert.ok(
  index.includes("synapse-legacy-controller-combined.js?v=source-preview-instant-v1"),
