...
assert.ok(index.includes("style.css?v=study-tools-ux-v1"), "styles should cache-bust for the resizable split");
assert.ok(
  index.includes("synapse-legacy-controller-combined.js?v=study-tools-ux-v1"),
