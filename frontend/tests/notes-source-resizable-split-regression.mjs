...
assert.ok(index.includes("style.css?v=pdf-review-clean-v1"), "styles should cache-bust for the resizable split");
assert.ok(
  index.includes("synapse-legacy-controller-combined.js?v=pdf-review-clean-v1"),
