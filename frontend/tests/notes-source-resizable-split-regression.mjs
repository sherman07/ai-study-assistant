...
assert.ok(index.includes("style.css?v=mindmap-original-v1"), "styles should cache-bust for the resizable split");
assert.ok(
  index.includes("synapse-legacy-controller-combined.js?v=mindmap-original-v1"),
