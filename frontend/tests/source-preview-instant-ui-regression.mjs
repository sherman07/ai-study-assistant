...
assert.ok(index.includes("style.css?v=study-tools-ux-v1"), "styles should cache-bust");
assert.ok(index.includes("synapse-legacy-controller-combined.js?v=study-tools-ux-v1"), "controller should cache-bust");
