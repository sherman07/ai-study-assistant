...
assert.ok(index.includes("style.css?v=mindmap-text-v1"), "styles should cache-bust");
assert.ok(index.includes("synapse-legacy-controller-combined.js?v=mindmap-text-v1"), "controller should cache-bust");
