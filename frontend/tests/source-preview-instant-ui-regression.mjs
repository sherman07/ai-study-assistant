...
assert.ok(index.includes("style.css?v=mindmap-clean-v1"), "styles should cache-bust");
assert.ok(index.includes("synapse-legacy-controller-combined.js?v=mindmap-clean-v1"), "controller should cache-bust");
