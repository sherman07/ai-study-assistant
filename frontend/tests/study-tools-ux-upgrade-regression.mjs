...
assert.ok(/mindmap-revert-v1|notes-taller-v2|notes-responsive-v2|credits-live-v2|a11y-skip-v1/.test(index), "workspace assets should cache-bust after study tools UX upgrade");
